...
QT_MOC_LITERAL(1, 16, 19), // "clientActionClicked"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "UI::ClientLabel\0clientActionClicked\0"
    ""
};
...
void UI::ClientLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clientActionClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ClientLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientLabel::clientActionClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UI::ClientLabel::clientActionClicked()
{
